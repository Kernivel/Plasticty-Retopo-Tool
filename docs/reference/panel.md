...
| **Corners (Grid)** | Angle | *Developer Mode only.* How a boundary is split into sides for the span generators. See [How it works](../how-it-works/generators.md#corners-then-sides) |
